...
public interface LoginContract {
    ...
    interface View extends BaseView {
        void handleVerifyCode(CodeBean mineCodeBean);//得到手机验证码后view层的处理
        String getWeChatOpenId();
        String getWeChatUnionId();
       void returnBindwx(WeiXinLoginBean data);
    }
    ...
    interface Model extends IModel {
        ...
        Observable<CodeBean> modifyPassword(String phoneNo, String passwd, String code);
